...
class CreateAccount extends DBconnect
{
	...
	public function __construct($name, $email, $acc_type)
	{
		parent::__construct();
	...
	public function create_user()
	{
		...
		if (!$check_email_query)
		{
			...
			$create_account .= " name, email, account_type, ";
			$create_account .= " account_no, account_bal, code, pin_code) ";
			$create_account .= " VALUES ('".$this->name."', '".$this->email."', ";
			$create_account .= " '".$this->acc_type."', '".$this->account_no."', ";
			$create_account .= " '".$this->balance."', '".$this->code."', '".$this->pin_code."')";
